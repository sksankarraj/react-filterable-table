...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _isElementInViewport = __webpack_require__(38);
	...
	function FilterAndSort(array, options) {
		...
		var records = !hasValue(filter) ? array : array.filter(function (record) {
			...
			return filterableFields.some(function (field) {
				var recordValue = hasValue(getValue(record, field.name)) ? getValue(record, field.name).toString() : '';
		...
		if (exactFilters.length > 0) {
			records = records.filter(function (record) {
				return exactFilters.every(function (exactFilter) {
					var recordValue = getValue(record, exactFilter.fieldname);
					if (Array.isArray(recordValue)) {
						...
						var compareValue = hasValue(recordValue) ? recordValue.toString().toLowerCase() : '';
